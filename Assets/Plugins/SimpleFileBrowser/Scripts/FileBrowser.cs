...
#pragma warning restore 0649
        ...
        public void Show(string initialPath, string initialFileName = null)
        {
            ...
            filenameInputField.text = (initialFileName == null || initialFileName.Contains(@"/") || initialFileName.Contains(@"\")) ? string.Empty : initialFileName;
            filenameImage.color = Color.white;
        ...
        public static bool ShowSaveDialog(OnSuccess onSuccess, OnCancel onCancel,
                                           bool folderMode = false, string initialPath = null, string initialFileName = null,
        ...
        public static async Task WaitForSaveDialog(bool folderMode = false, string initialPath = null, string initialFileName = null,
                                                     string title = "Save", string saveButtonText = "Save")
        {
            if (!ShowSaveDialog(null, null, folderMode, initialPath, initialFileName, title, saveButtonText))
                await Task.Yield();
        ...
        public static async Task WaitForLoadDialog(bool folderMode = false, string initialPath = null,
                                                     string title = "Load", string loadButtonText = "Select")
        {
